...
Background = pygame.image.load("E:\Python\Tycoon\Graphics\Menu\MenuBackground.png").convert_alpha()
Start_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Menu\Start_Button.png").convert_alpha()
Modes_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Menu\Modes_Button.png").convert_alpha()
Host_A_Game_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Menu\Host_Multiplayer_Button.png").convert_alpha()
Join_A_Game_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Menu\Join_Multiplayer_Button.png").convert_alpha()
Modes_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Menu\Modes_Button.png").convert_alpha()
Modes_Background = pygame.image.load("E:\Python\Tycoon\Graphics\Menu\Modes_Background.png").convert_alpha()
Shop_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Shop\Shop_Button.png").convert_alpha()
Shop_Background = pygame.image.load("E:\Python\Tycoon\Graphics\Shop\Shop_Background.png").convert_alpha()
Buy_Battery_Worker_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Shop\Buy_Battery_Worker.png").convert_alpha()
Increase_Battery_Button = pygame.image.load("E:\Python\Tycoon\Graphics\Shop\Increase_Battery_Cap.png").convert_alpha()
